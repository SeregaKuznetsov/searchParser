...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int docsCount = (int) Util.getDocsCount(("src/main/resources/articles")) - 1;
        ...
        for (int i = 1; i < docsCount + 1; i++) {
            for (int j = 0; j < links.size(); j++) {
                String article = Util.readArticle("src/main/resources/articles/" + i + ".txt");
        ...
        Util.arrayToFile("src/main/resources/table/table.txt", linkTable);
